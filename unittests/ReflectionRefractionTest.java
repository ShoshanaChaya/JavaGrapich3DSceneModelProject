...
public class ReflectionRefractionTest {
    ...
    /**
     * Produce a picture of a two triangles lighted by a spot light and directional light with a partially transparent Sphere and a reflected sphere
     */
    @Test
    public void nofun() {
        Scene scene = new Scene("Test scene");
        ...
        scene.addGeometries(
                new Triangle(new Color(20, 20, 20), new Material(0, 0, 1000, 0, 1),
                        new Point3D(-150, 150, 150), new Point3D(150, 150, 150), new Point3D(75, -75, 150)),
                new Triangle(new Color(20, 20, 20), new Material(0, 0, 1000, 0, 0.5),
        ...
        scene.addLights(new SpotLight(new Color(400, 240, 0), //
                new Point3D(-80, 80, -100), new Vector(1, -1, 3), 1, 1E-5, 1.5E-7),
                new DirectionalLight(new Color(50, 300, 100), new Vector(1, -1, 1)));

        ImageWriter imageWriter = new ImageWriter("nofun", 200, 200, 600, 600);
        Render render = new Render(imageWriter, scene);
