...
public class Color {
     ...
     */
    private Color subtract(Color color) {
        double r = this._r - color._r;
        double g = this._g - color._g;
        double b = this._b - color._b;
        // if the color isn't valid - we set it to be black
        if(r < 0){
            r = 0;
        }
        if(g < 0){
    ...
    public boolean equals(Object o) {
        ...
        Color color = (Color) o;
        Color c = color.subtract(this);
        // if the color is different up to 5 units
        if(c._r <= 5 && c._g <= 5 && c._b <= 5){
            return true;
        }
        return false;
    }
